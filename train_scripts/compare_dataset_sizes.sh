...
cmds=(
  'python -m train --out_dir sizes/25  --trainset_frac 0.20       --model resnet50 --use_weights --data_split_seed 1 --aug s --balance b --epochs 50 --norm_method min-max --display_method stack3 --masked_norm --num_runs 10'
